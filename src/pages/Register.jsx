                ...
                {roles.map((role) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-2 rounded-xl border-2 p-4 transition-all duration-200 ${isSelected
                          ? "border-[#EC4899] bg-[#FDF2F8] shadow-pink"
                          : "border-[#FBB6CE]/20 bg-white hover:border-[#FBB6CE]/40"
                        }`}
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center transition-colors ${isSelected ? "bg-[#EC4899] text-white" : "bg-[#FDF2F8] text-[#EC4899]"
                        }`}>
